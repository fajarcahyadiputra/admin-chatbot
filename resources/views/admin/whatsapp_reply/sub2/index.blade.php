            ...
            <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a
                            href="{{ route('admin.whatsapp_reply.sub1', ['id' => $master->master_id]) }}">List Sub1 Whatsapp
                            Replies</a></li>
                    <li class="breadcrumb-item active" aria-current="page">List Sub2 {{ $master->name }}</li>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="btn-group dropstart">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a href="{{ route('admin.whatsapp_reply.sub1', ['id' => $whatsappReply->id]) }}"
