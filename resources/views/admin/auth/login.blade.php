...
<head>
    ...
    <link
        href="{{ asset('assets/layouts/vertical-dark-menu/css/light/loader.css" rel="stylesheet" type="text/css') }}" />
    <link
        href="{{ asset('assets/layouts/vertical-dark-menu/css/dark/loader.css" rel="stylesheet" type="text/css') }}" />
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        @if ($errors->any())
                                            @foreach ($errors->all() as $err)
                                                <p class="alert alert-danger text-black">{{ $err }}</p>
                                            @endforeach
                                        @endif
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-4">
                                            ...
                                            <input required type="password"
                                                @if (session('error')) class="is-invalid" @endif
                                                name="password" required type="text" class="form-control">
                                        </div>
                                    </div>
                                    {{-- <div class="col-12">
                                        <div class="mb-3">
